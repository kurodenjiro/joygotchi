...
<Tooltip key={"default"}  color={"default"} content={`Feed 1 ${item.name} : ${parseInt(item.points).toFixed(2).toString()} PTS & ${(parseInt(item.timeExtension)/3600).toFixed(2).toString()} TOD with ${(parseInt(item.price)/1e18).toString()} Joy`} className="capitalize">
